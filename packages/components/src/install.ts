...
import { QCheckboxGroup } from './components/form/CheckboxGroup';
import { QColorPicker } from './components/form/ColorPicker';
import { QDatePicker } from './components/form/DatePicker';
import { QFileUpload } from './components/form/FileUpload';
import { QInput } from './components/form/Input';
import { QForm } from './components/form/QForm';
import { QFormItem } from './components/form/QFormItem';
import { QRadioGroup } from './components/form/RadioGroup';
import { QRangeSlider } from './components/form/RangeSlider';
import { QSearch } from './components/form/Search';
import { QSelect } from './components/form/Select';
import { QSwitch } from './components/form/Switch';
import { QTextArea } from './components/form/TextArea';
...
export function install(app: App) {
  ...
  app.component('QColorPicker', QColorPicker);
  app.component('QDatePicker', QDatePicker);
  app.component('QFileUpload', QFileUpload);
  app.component('QInput', QInput);
  app.component('QRadioGroup', QRadioGroup);
  app.component('QRangeSlider', QRangeSlider);
  app.component('QSelect', QSelect);
  app.component('QSwitch', QSwitch);
