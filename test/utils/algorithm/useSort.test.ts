...
import { BubbleSort, SelectionSort, InsertionSort, HeapSort, MergeSort, QuickSort, CountingSort, RadixSort, BucketSort } from '@/utils';
...
describe('Sorting Algorithms', () => {
    ...
    describe('BucketSort', () => {
        it('should sort numbers in [0,1) range', () => {
            ...
            expect(result).toEqual([0.12, 0.17, 0.21, 0.23, 0.26, 0.39, 0.68, 0.72, 0.78, 0.94]);
        });
        ...
        it('should handle duplicate elements', () => {
            ...
            const result = BucketSort([...arr]);
            expect(result).toEqual([0.1, 0.1, 0.2, 0.3, 0.3, 0.4, 0.5, 0.5, 0.5, 0.6, 0.9]);
        });
